...
namespace siber
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            process_nmap.Start();
            StreamWriter sr_out = new StreamWriter("nmap onurincik.txt");
            StreamWriter sr_err = new StreamWriter("nmap hatalar.txt");
            ...
            Console.WriteLine("nmap çalışmayı bitirdi Sonuçlar :" + nmap_exit_code);
